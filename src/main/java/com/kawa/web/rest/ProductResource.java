...
public class ProductResource {
    ...
    public ResponseEntity<InsertResponseDTO> createProduct(@Valid @RequestBody ProductInsertRequestDTO productRequestDTO) {
        log.info("REST request to save Product : {}", productRequestDTO);
        InsertResponseDTO result = productService.insertProduct(productRequestDTO);
        return ResponseEntity.ok().body(result);
    }
}
